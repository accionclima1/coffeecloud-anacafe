...
app.factory('widget', ['$http', function ($http) {
    ...
    w.getAll = function () {
        ...
        return $http.get('http://163.172.152.189:8091/getWidgets').success(function (data) {
            return data;
        });
    };
    return w;
...
app.factory('posts', ['$http', 'auth', function ($http, auth) {
    ...
    o.getAll = function () {
        return $http.get('http://163.172.152.189:8091/posts').success(function (data) {

            angular.copy(data, o.posts);
        });
    };
    o.create = function (post) {
        return $http.post('http://163.172.152.189:8091/posts', post, {
    ...
    o.upvote = function (post) {
        return $http.put('http://163.172.152.189:8091/posts/' + post._id + '/upvote', null, {
    ...
    o.get = function (id) {
        return $http.get('http://163.172.152.189:8091/posts/' + id).then(function (res) {
            return res.data;
        });
    };
    o.addComment = function (id, comment) {
        return $http.post('http://163.172.152.189:8091/posts/' + id + '/comments', comment, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        });
    };
    o.upvoteComment = function (post, comment) {
        return $http.put('http://163.172.152.189:8091/posts/' + post._id + '/comments/' + comment._id + '/upvote', null, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        })
          .success(function (data) {
              comment.upvotes += 1;
...
app.factory('user', ['$http', 'auth', function ($http, auth) {
  ...
  headers: {Authorization: 'Bearer '+auth.getToken()}
    ...
    o.getAll = function () {
        return $http.get('http://163.172.152.189:8091/users', {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).then(function (res) {
            return res.data;
        });
    ...
    o.get = function (id) {
        return $http.get('http://163.172.152.189:8091/users/' + id).then(function (res) {
            return res.data;
        });
    };
...
app.factory('auth', ['$http', '$state', '$window', function ($http, $state, $window) {
    ...
    auth.logIn = function (user) {
        return $http.post('http://163.172.152.189:8091/login', user).success(function (data) {
            auth.saveToken(data.token);
        });
    };
    // Tech 12 / 1
    ...
    auth.GenOtp = function (user) {
        /*return $http.post('http://163.172.152.189:8091/requestpasswordchange', user).success(function(data){
          auth.saveToken(data.token);
        });*/
        //return $http.post('http://163.172.152.189:8091/requestpasswordchange', user).success(function (data) {
        //    return data;
...
app.factory('unit', ['$http', 'auth', '$window', function ($http, auth, $window) {
    ...
    o.getAll = function (id) {
        return $http.get('http://163.172.152.189:8091/users/' + id + '/units').success(function (data) {
            return data;
        });
    };
    o.get = function (userId, id) {
        return $http.get('http://163.172.152.189:8091/users/' + userId + '/units/' + id).then(function (res) {
            return res.data;
        });
    };
    ...
    o.create = function (unit, id) {
        //localhost unit
        return $http.post('http://163.172.152.189:8091/users/' + id + '/units', unit, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.update = function (unit, id, unitData) {
        //localhost unit
        return $http.put('http://163.172.152.189:8091/users/' + id + '/units/' + unit, unitData, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data
        });
    ...
    o.deleteUnit = function (unitId, userId) {
        return $http.delete('http://163.172.152.189:8091/users/' + userId + '/units/' + unitId, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return unitId;
        });
    ...
    o.SyncUserServerDataToLocalPouchDb = function (lastSyncDateTime, id) {
        return $http.post('http://163.172.152.189:8091/SyncUserServerData/' + id + "/"+ lastSyncDateTime, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
...
app.factory('varieties', ['$http', 'auth', '$window', function ($http, auth, $window) {
    var o = {};
    o.getAll = function () {
        return $http.get('http://163.172.152.189:8091/varieties').success(function (data) {
            return data;
        });
    };
    o.create = function (varieties) {
        //localhost unit
        return $http.post('http://163.172.152.189:8091/varieties', varieties, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.deleteVariety = function (Ided) {
        return $http.delete('http://163.172.152.189:8091/varieties', {
...
app.factory('fungicidas', ['$http', 'auth', '$window', function ($http, auth, $window) {
    var o = {};
    o.getAll = function () {
        return $http.get('http://163.172.152.189:8091/fungicidas').success(function (data) {
            return data;
        });
    };
    o.create = function (fungicidas) {
        //localhost unit
        return $http.post('http://163.172.152.189:8091/fungicidas', fungicidas, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.update = function (fungicidas) {
        //localhost unit
        return $http.post('http://163.172.152.189:8091/fungicidas/update', fungicidas, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.deleteFungicida = function (Ided) {
        return $http.delete('http://163.172.152.189:8091/fungicidas', {
...
app.factory('methods', ['$http', 'auth', function ($http, auth) {
    ...
    o.get = function () {
        return $http.get('http://163.172.152.189:8091/admin/methods/').success(function (data) {
            return data;
        });
    };
    o.create = function (method) {
        return $http.post('http://163.172.152.189:8091/admin/methods', method, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.update = function (method) {
        return $http.put('http://163.172.152.189:8091/admin/methods', method, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
...
app.factory('methodsGallo', ['$http', 'auth', function ($http, auth) {
    ...
    o.get = function () {
        return $http.get('http://163.172.152.189:8091/admin/methodsGallo/').success(function (data) {
            return data;
        });
    };
    o.create = function (methodGallo) {
        return $http.post('http://163.172.152.189:8091/admin/methodsGallo', methodGallo, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.update = function (methodGallo) {
        return $http.put('http://163.172.152.189:8091/admin/methodsGallo', methodGallo, {
...
app.factory('campoService', ['$http', 'auth', function ($http, auth) {
    ...
    o.get = function () {
        return $http.get('http://163.172.152.189:8091/admin/campo/').success(function (data) {
            return data;
        });
    };
    o.getUser = function (userID) {
        return $http.get('http://163.172.152.189:8091/admin/campo/' + userID).success(function (data) {
            return data;
        });
    };
    o.create = function (method) {
        return $http.post('http://163.172.152.189:8091/admin/campo', method, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.SaveCampoUnitTest = function (data) {
        return $http.post('http://163.172.152.189:8091/admin/campo/addtests', data, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
...
app.factory('roya', ['$http', 'auth', function ($http, auth) {
    ...
    o.getAll = function () {
        return $http.get('http://163.172.152.189:8091/roya').success(function (data) {
            return data;
        });
    };
    o.getUser = function (userID) {
        return $http.get('http://163.172.152.189:8091/roya/' + userID).success(function (data) {
            return data;
        });
    };
    o.create = function (roya) {
        console.log("Result Roya: ", roya);
        return $http.post('http://163.172.152.189:8091/roya?tmp=' + (new Date()).getTime(), roya, {
...
app.factory('gallo', ['$http', 'auth', function ($http, auth) {
    ...
    o.getAll = function () {
        return $http.get('http://163.172.152.189:8091/gallo').success(function (data) {
            return data;
        });
    };
    o.getUser = function (userID) {
        return $http.get('http://163.172.152.189:8091/gallo/' + userID).success(function (data) {
            return data;
        });
    };
    o.create = function (gallo) {
        return $http.post('http://163.172.152.189:8091/gallo?tmp=' + (new Date()).getTime(), gallo, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
...
app.factory('chats', ['$http', 'auth', function ($http, auth) {
    ...
    o.getAll = function () {
        return $http.get('http://163.172.152.189:8091/chats').success(function (data) {
            return data;
        });
    };
    o.getUser = function (userID) {
        return $http.get('http://163.172.152.189:8091/chats/' + userID).success(function (data) {
            return data;
        });
    };
    o.create = function (chats) {
        console.log("Result Chats: ", chats);
        return $http.post('http://163.172.152.189:8091/chats?tmp=' + (new Date()).getTime(), chats, {
...
app.factory('messages', ['$http', 'auth', function ($http, auth) {
    ...
    o.getAll = function () {
        return $http.get('http://163.172.152.189:8091/messages').success(function (data) {
            return data;
        });
    };
    o.getUser = function (userID) {
        return $http.get('http://163.172.152.189:8091/messages/' + userID).success(function (data) {
            return data;
        });
    };
    o.create = function (messages) {
        console.log("Result Messages: ", messages);
        return $http.post('http://163.172.152.189:8091/messages?tmp=' + (new Date()).getTime(), messages, {
...
app.factory('vulnerabilidades', ['$http', 'auth', '$window', function ($http, auth, $window) {
    ...
    o.getAll = function (id) {
        ...
        var serviceURL = "http://163.172.152.189:8091/users/";
        /*ea0707*/
    ...
    o.create = function (encuesta, id) {
        //localhost unit
        return $http.post('http://163.172.152.189:8091/users/' + id + '/encuesta', encuesta, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
