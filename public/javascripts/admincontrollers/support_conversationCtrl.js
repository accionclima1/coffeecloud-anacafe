...
app.controller('support_conversationCtrl',['$scope','auth', 'socket', 'user','support_detail', '$state', '$stateParams',
function ($scope, auth, socket, user, support_detail, $state, $stateParams) {
