...
app.controller('support_mainCtrl',['$scope','auth', 'socket', 'user', 'support_head', '$state', '$stateParams','$rootScope',
function ($scope, auth, socket, user, support_head, $state, $stateParams,$rootScope) {
